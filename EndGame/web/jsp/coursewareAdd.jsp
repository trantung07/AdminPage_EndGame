<%-- 
    Document   : coursewareAdd
    Created on : 26-Jun-2019, 21:54:41
    Author     : Tran Tung
--%>
                        ...
                        <div class="container">
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <h4>Thêm mới học liệu</h4>
                                </div>
                                <div class="panel-body">

                                <f:form class="form-horizontal" action="insertCourseware.htm" commandName="newCourseware" enctype="multipart/form-data">
