            ...
            <jsp:include page="slideBar.jsp"></jsp:include>    
                ...
                <div id="page-content">
                    <div id='wrap'>
                        <div id="page-heading">
                            <ol class="breadcrumb">
                                <li class='active'><a href="#">Quản lý bài học</a></li>
                            </ol>
                                        ...
                                        <div class="panel-body">
                                            <div class="table-flipscroll">
                                                ...
                                                <p><div class="pagination1">${url}</div><span style="float: right; font-size: 13px;">Hiển thị từ 
                                                    <span style="font-weight: bold">${startIndex}</span> - <span style="font-weight: bold">${endIndex}</span> trên tổng số <span style="font-weight: bold">${size}</span> khóa học</span></p>
                                                <table class="table">
                                                    <thead>
                                                        <tr>
